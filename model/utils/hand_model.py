...
class HandModel:
    def __init__(self, cfg, device):
        ...
        fingertip_points_path = cfg.fingertip_points_path 
    ...
    def __call__(self, hand_pose, object_pc=None, with_meshes=False, with_surface_points=False, with_contact_candidates=False, with_penetration_keypoints=False, with_penetration=False):
